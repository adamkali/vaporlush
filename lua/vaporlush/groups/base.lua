...
function M.set(c, opts, nvim_set_hl)
    local default = { fg = c.fg, bg = c.bg }
    ---@type { [string]: VaporLush.Mapping }
    local mappings = {
        Foo                         = { bg = c.bg, fg = c.fg },
        ...
        Directory                   = { fg = c.primary0 },                          -- directory names (and other special names in listings)
        ...
        PmenuMatchSel               = { bg = Util.blend_bg(c.fg, 0.8), fg = c.blue1 },   -- Popup menu: Matched text in selected item.
        ...
        Function                    = { fg = c.primary3, italic = true },    -- function name (also: methods for classes)
        Identifier                  = { fg = c.tertiary2, italic = true }, -- (preferred) any variable name
        Italic                      = { italic = true, fg = c.fg },                      -- (preferred) any italic text
        Keyword                     = { fg = c.quartary1, bold = true},     --  any other keyword
        Operator                    = { fg = c.primary0 },                                  -- "sizeof", "+", "*", etc.
        PreProc                     = { fg = c.quartary0 },                                   -- (preferred) generic Preprocessor
        Statement                   = { fg = c.quartary1 },                                -- (preferred) any statement
        String                      = { fg = c.primary3 },                                  --   a string constant: "this is a string"
